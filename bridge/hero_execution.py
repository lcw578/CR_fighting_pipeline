...
WIZARD = 26000017
WIZARD_HERO_ABILITY = 'WizardHeroAbility'
# Deployed elite-form entity data ids follow the 203000000 + card number pattern;
# both values are pattern-derived and get confirmed by the spawn watch in battle.
HERO_FORM_ENTITIES = {MUSKETEER: 203000014, WIZARD: 203000017}
